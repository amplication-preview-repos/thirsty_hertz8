...
@InputType()
class MaintenanceRecordCreateNestedManyWithoutServiceCentersInput {
...
export { MaintenanceRecordCreateNestedManyWithoutServiceCentersInput as MaintenanceRecordCreateNestedManyWithoutServiceCentersInput };
