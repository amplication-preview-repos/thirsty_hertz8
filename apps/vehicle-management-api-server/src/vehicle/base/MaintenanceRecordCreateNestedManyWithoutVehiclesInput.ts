...
@InputType()
class MaintenanceRecordCreateNestedManyWithoutVehiclesInput {
...
export { MaintenanceRecordCreateNestedManyWithoutVehiclesInput as MaintenanceRecordCreateNestedManyWithoutVehiclesInput };
