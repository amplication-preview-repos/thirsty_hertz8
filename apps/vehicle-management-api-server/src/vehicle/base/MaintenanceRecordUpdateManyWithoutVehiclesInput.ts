...
@InputType()
class MaintenanceRecordUpdateManyWithoutVehiclesInput {
...
export { MaintenanceRecordUpdateManyWithoutVehiclesInput as MaintenanceRecordUpdateManyWithoutVehiclesInput };
