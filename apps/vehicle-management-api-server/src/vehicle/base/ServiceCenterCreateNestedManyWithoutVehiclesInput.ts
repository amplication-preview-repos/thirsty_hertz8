...
@InputType()
class ServiceCenterCreateNestedManyWithoutVehiclesInput {
...
export { ServiceCenterCreateNestedManyWithoutVehiclesInput as ServiceCenterCreateNestedManyWithoutVehiclesInput };
